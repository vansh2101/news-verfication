...
function LinkNewsContent() {
  ...
  const newsData = {
    ...
    link: articles[0] ? {
      ...
      url: articles[0].url,
      image: articles[0].urlToImage || "/placeholder.svg",
    } : null,
  }
  ...
  return (
    <main className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-foreground mb-8">Verify News Link</h1>
        ...
        {!loading && !error && newsData.link && (
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3">
              <h2 className="text-2xl font-bold text-foreground mb-4">News Link</h2>
              <Card className="p-8 border-2 rounded-2xl">
                {/* Link Preview */}
                <div className="border-2 rounded-2xl overflow-hidden hover:shadow-lg transition-shadow">
                  {newsData.link.image && (
                    <img
                  ...
                  <div className="p-4 bg-muted">
                    <h3 className="font-bold text-foreground mb-2">{newsData.link.title}</h3>
                    <p className="text-sm text-muted-foreground mb-3">{newsData.link.description}</p>
                    <a
...
export default function LinkNewsPage() {
  return (
    <Suspense fallback={
      <main className="min-h-screen bg-background p-6">
        <div className="max-w-7xl mx-auto">
