...
function VideoNewsContent() {
  ...
  const newsData = {
    ...
    video: articles[0] ? {
      ...
      thumbnail: articles[0].urlToImage || "/placeholder.svg",
      duration: "3:45",
      url: articles[0].url
    } : null,
  }
  ...
  return (
    <main className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-foreground mb-8">Verify News Video</h1>
        ...
        {!loading && !error && newsData.video && (
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3">
              <h2 className="text-2xl font-bold text-foreground mb-4">News Video</h2>
              <Card className="p-8 border-2 rounded-2xl">
                ...
                <div className="relative group">
                  ...
                  <a 
                    ...
                    className="absolute inset-0 bg-black/30 hover:bg-black/40 transition-colors rounded-2xl flex items-center justify-center"
                  >
                ...
                <h3 className="text-lg font-bold text-foreground mt-4">{newsData.video.title}</h3>
              </Card>
            </div>
          </div>
        )}
