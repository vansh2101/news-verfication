  ...
  return (
    <div className="space-y-4">
      {claims.map((claim, index) => {
        ...
        return (
          <div key={claim.id || index} className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-all">
            ...
            <p className="text-sm text-gray-800 leading-relaxed mb-3 font-medium line-clamp-2">
              "{claimText.length > 150 ? claimText.substring(0, 150) + '...' : claimText}"
            </p>

            {/* Explanation - Truncated */}
            {explanation && (
              <div className="bg-gray-50 border-l-4 border-l-blue-400 pl-3 py-2 mb-3 rounded">
